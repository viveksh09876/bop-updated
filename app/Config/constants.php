...
define('SITE_URL', 'http://localhost/bop/bop-updated/beta/');

//define('SITE_URL', 'http://bestofpedigree.com/beta/');
define('APPLICATION_NAME','Best of Pedigree');
define('CAKE_ADMIN', 'admin');
define('ADMIN_EMAIL','purgitoryfallen@gmail.com');
...
define('UPLOAD_EMPLICENCEIMG_DIR', UPLOAD_DIR.DS.'employer_licence_img'.DS);
define('UPLOAD_BACKGROUNDIMG_DIR', UPLOAD_DIR.DS.'pet_background_img'.DS);
define('UPLOAD_ENERGYBONEIMG_DIR', UPLOAD_DIR.DS.'energy_bone_img'.DS);
define('UPLOAD_RETIREMENTMEDALIMG_DIR', UPLOAD_DIR.DS.'retirement_medal_img'.DS);
define('UPLOAD_BREEDRIBBONIMG_DIR', UPLOAD_DIR.DS.'breed_ribbon_img'.DS);

define('UPLOAD_USERIMG_DIR', UPLOAD_DIR.DS.'user_images'.DS);
define('DISPLAY_USERIMG_DIR', SITE_URL.UPLOAD_DIR.'/user_images/');
...
define('UPLOAD_SHOW_DIR', UPLOAD_DIR.DS.'shows'.DS);
define('DISPLAY_SHOW_DIR', SITE_URL.UPLOAD_DIR.'/shows/');
define('UPLOAD_KENNELBANNER_DIR', UPLOAD_DIR.DS.'kennel_banners'.DS);
define('UPLOAD_KENNELAVATAR_DIR', UPLOAD_DIR.DS.'kennel_avatars'.DS);
