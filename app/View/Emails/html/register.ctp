...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="border:1px solid #eaeaea; margin-top:20px;">
  ...
  <tr>
    <td>
		...
		<a href="<?php echo Router::url(array ('controller' => 'users', 'action' => 'verify', $user['User']['verification_code']), true); ?>" style="color:#21759b;" >
			<?php echo Router::url(array ('controller' => 'users', 'action' => 'verify', $user['User']['verification_code']), true); ?>
		</a>
		<br><br>
		<?php
