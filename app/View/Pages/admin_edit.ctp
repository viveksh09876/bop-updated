...
<div class="pages row">
    <div class="floatleft mtop10"><h2><?php echo __('Admin Edit Page'); ?></h2></div>
...
<div align="center" class="whitebox mtop15">
	...
	?>
        ...
        <tr>
            <td align="left"></td>
            <td align="left"><div class="black_btn2"><span class="upper"><?php echo $this->form->submit('submit',array('type' => 'submit', 'id'=>'page_edit'));?></span></div></td>
        </tr>
