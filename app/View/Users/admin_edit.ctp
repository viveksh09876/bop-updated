<div class="faqs row">
    <div class="floatleft mtop10"><h2><?php echo __('Edit User'); ?></h2></div>
    <?php
...
<div align="center" class="whitebox mtop15">
    ...
    <table cellspacing="0" cellpadding="7" border="0" align="center">
       ...
       <?php echo $this->Form->input('old_image',array('type'=>'hidden','value'=>$this->request->data['User']['photo']))?>
         <?php echo $this->Form->input('id',array('type'=>'hidden','value'=>$this->request->data['User']['id']))?>
       <?php if($this->request->data['User']['photo']){?>
        <tr>
        <td align="left">&nbsp;</td>
			<td align="left"><img src="<?php echo $this->webroot;?>files/user_images/<?php echo $this->request->data['User']['photo'] ?>" style="max-width: 300px"></td>
            </tr>
       <?php } ?>
