...
<script type="text/javascript">
	...
	function add_colors() {
		...
		$('#colorsTable').append('<tr id="row_'+num+'"><td>'+num+'</td><td><input class="required"  type="file" name="img['+num+'][filename]" /> (Upto 2 MB)</td><td><input class="required" type="file" name="img['+num+'][filename_adult]" /> (Upto 2 MB)</td><td><input class="required"  type="text" name="data[Breed][img]['+num+'][breed_color]"></td><td><input class="required"  type="text" name="data[Breed][img]['+num+'][breed_marking]"></td><td><a href="javascript://" onclick="delete_color('+num+'); ">Delete</a></td></tr>');
