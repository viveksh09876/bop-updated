...
<div class="panel panel-default" style="margin:36px;">
                        <div class="panel-heading">Adoption Center</div>
<div class="panel-body"> 
                        <div class="instagram-panel">									
                            <?php echo $this->Session->flash(); ?>	
<?php if(!empty($banners['ManageBanner']['adoption_banner'])){?>
 <center><img src="<?php echo $this->webroot; ?>files/kennel_banners/<?php echo $banners['ManageBanner']['adoption_banner']; ?>" class="img-responsive">	</center>
<?php }?>
