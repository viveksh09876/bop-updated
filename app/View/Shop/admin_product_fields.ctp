        ...
        <tr>
           ...
           <tr>
			...
			<td align="left"><?php
                ...
                <?php }else if($ProductType=='8'){ ?>
                  <?php echo $this->Form->create('GameFund',array('url'=>array('controller'=>'shop','action'=>'add'))); ?>
                   <table cellspacing="0" cellpadding="7" border="0" align="center">

                        <tr>
			<td align="left"><strong class="upper">Product Type</strong></td>
			<td align="left"><?php
			echo $this->Form->input('Product.product_id',array('class' => 'input required', 'label' => false, 'error' => false, 'div' => false, 'style'=>'width: 450px;','options'=>$products,'empty'=>'Select Product','onChange'=>'getProductFields(this.value)','value'=>'8'));?>
			</td>
		</tr>
                <tr>
