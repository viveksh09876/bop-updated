...
<li> <?php echo $this->Form->input('payment_mode',array('class'=>'required','label'=>false,'div'=>false,'options'=>array('Game Cash'=>'Game Cash','Bones'=>'Bones'),'empty'=>'Select','style'=>'width:200px;height:35px')); ?><label>BUY WITH</label></li>
