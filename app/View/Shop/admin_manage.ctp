...
<div class="faqs index">
	...
	<?php //echo $this->Form->create('Breed', array('controller'=>'breeds', 'action'=>'delete_multiple','admin'=>true));?>
	    ...
	    <?php
			foreach ($shops as $shop): ?>
			<tr>
				<td align="left" valign="middle"><?php echo $shop['GameFund']['game_funds'];?></td>
                                <td align="left" valign="middle"><?php echo $shop['GameFund']['credits_to_buy'];?></td>
                                <td align="left" valign="middle"><?php echo format_date($shop['GameFund']['added_date']);  ?></td>
				<td align="center">
				<?php echo $this->Html->link($this->Html->image(ADMIN_IMAGES_PATH.'edit.gif'), array('action' => 'admin_edit', $shop['GameFund']['id'],$product_type),array('escape'=>false)); ?>&nbsp;
			        <?php echo $this->Html->link($this->Html->image(ADMIN_IMAGES_PATH.'trash.gif'), array('action' => 'admin_delete', $shop['GameFund']['id'],$product_type),array('escape'=>false), __('Are you sure you want to delete?', isset($shop['EnergyBone']['id']) ? $shop['EnergyBone']['id'] : '')); ?>   
				</td>
			</tr>
			<?php endforeach; ?>
			<tr align='right'>
