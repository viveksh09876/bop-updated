	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
		<tr valign="top">
		  <td align="left" class="searchbox">
			<div class="floatleft">
				<?php echo $this->Form->create(null, array('url' => array('controller' => 'aboutus', 'action' => 'teamlist', 'admin' => true), 'name' => 'frm_srch', 'id' => 'frm_srch', 'type' => 'get', 'inputDefaults' => array('label' => false, 'div' => false, 'error' => false))) ?>
			...
			<div class="floatright top5">
				<?php echo $this->Html->link('<span>Add Team Member</span>', array('controller' => 'aboutus', 'action' => 'teamadd'), array('class' => 'blue_btn', 'escape' => false)) ?>
			</div>
		  </td>
	  </tr>
	</table>
		...
		<br clear="all" /><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			if(count($result_arr))
			{
				...
				<tr class="<?=$bgClass?>">
					...
					<td align="center">
						<?php echo $this->Html->image(ADMIN_IMAGES_PATH.'edit_icon.gif', array('url'=>array('controller'=>'aboutus', 'action'=>'teamedit', $row['id'], 'admin'=>true))); ?>
					</td>
