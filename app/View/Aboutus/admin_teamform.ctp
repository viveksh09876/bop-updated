<script>
    ...
    <div class="row">
		...
		<div class="floatright"><?php echo $this->Html->link('<span>Back to Team Members List</span>', array('controller' => 'aboutus', 'action' => 'admin_teamlist'), array('class' => 'black_btn', 'escape' => false)) ?></div>
    </div>
		...
		<?php echo $this->Form->create('Aboutus', array('url' => null, 'name' => 'frm_addedit', 'id' => 'frm_addedit', 'method' => 'post', 'inputDefaults' => array('label' => false, 'div' => false, 'error' => false), 'type'=>'file')) ?>
			...
			<table cellspacing="0" cellpadding="7" border="0" align="center">
				...
				<tr>
					...
					<td><?php echo $this->Form->input('desc', array('class' => 'input', 'style' => "width: 450px;", 'rows' => 5)); ?></td>
				</tr>
				<tr>
					...
					<td>
						...
						?>
							<img src="<?php echo create_thumb_imgname($this->data['Aboutus']['filename'], 110, 110, DISPLAY_ABOUTUS_DIR) ?>" /> 
						<?php
