	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
		<tr valign="top">
		  <td align="left" class="searchbox">
			<div class="floatleft">
				<?php echo $this->Form->create(null, array('url' => array('controller' => 'aboutus', 'action' => 'blocklist', 'admin' => true), 'name' => 'frm_srch', 'id' => 'frm_srch', 'type' => 'get', 'inputDefaults' => array('label' => false, 'div' => false, 'error' => false))) ?>
			...
			<div class="floatright top5">
				<?php echo $this->Html->link('<span>Add Block</span>', array('controller' => 'aboutus', 'action' => 'blockadd'), array('class' => 'blue_btn', 'escape' => false)) ?>
			</div>
		  </td>
	  </tr>
	</table>
	...
	<form name="frm_user" id="frm_user" action="<?php echo $this->Html->url(array('controller' => 'aboutus', 'action' => 'manage_actions')); ?>" method="post" onsubmit="return CheckUserAction(this)">
		<br clear="all" /><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			<tr>
				...
				<th width="15%" align="center" nowrap="nowrap">Type</th>
			...
			if(count($result_arr))
			{
				...
				<tr class="<?=$bgClass?>">
					...
					<td align="left"><?php echo $ARR_ABOUTUS_BLOCK_TYPE[$row['type']]; ?></td>
					<td align="left"><?php echo formatDateTime($row['created']);?></td>
					<td align="center">
						<?php echo $this->Html->image(ADMIN_IMAGES_PATH.'edit_icon.gif', array('url'=>array('controller'=>'aboutus', 'action'=>'blockedit', $row['id'], 'admin'=>true))); ?>
					</td>
			...
			?>
			<tr>
                <td colspan="6" align="left" class="bordernone">
