...
<div align="center" class="whitebox mtop15">
    ...
    <table cellspacing="0" cellpadding="7" border="0" align="center">
		<tr>
			...
			<td align="left"><?php	echo $this->Form->input('image',array( 'label' => false,'type'=>'file','div'=>false));?>
                            <?php 
                           if(!empty($rs["Forum"]["post_image"])){
                            echo  $this->Html->image("forums/".$rs["Forum"]["post_image"],array("width"=>"100px","height"=>"50px"));
                           }
                            ?>
