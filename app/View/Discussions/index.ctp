    ...
    <div class="row">
        <div class="col-sm-3 col-md-2">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="<?php echo $this->Html->url(array("action" => "index")); ?>">Inbox </a>
                </li>
                <li><a href="<?php echo $this->Html->url(array("action" => "sent")); ?>">Sent Mail</a></li>
            </ul>
        </div>
                    ...
                    <div class="list-group">
                        ...
                        if (!empty($all_messages)) {
                            foreach ($all_messages as $message) {
                                // pr($message);
                                $Font_wei="";
                                if($message["UsersDiscussion"]["status"]==0){
                                $Font_wei="bold";    
                                }
                                ?>
                        <div class="list-group-item"><a  href="<?php echo $this->Html->url(array("action"=>"view",$message["UsersDiscussion"]["id"]))?>" style="cursor:pointer; font-weight: <?php echo $Font_wei;?>">
                                        <span class="name" style="min-width: 120px;
                                              display: inline-block;"><?php printf("%s %s", $message["Sender"]["first_name"], $message["Sender"]["last_name"]) ?>
                                        </span> 
                                    ...
                                    <span class="pull-right">
                                        &nbsp;
                                        <?php //echo $this->Html->link('<span class="glyphicon glyphicon-trash"></span>', array("action" => "delete", $message["UsersDiscussion"]["id"],1), array("confirm" => "Do you want delete?", "escape" => false)); ?>
