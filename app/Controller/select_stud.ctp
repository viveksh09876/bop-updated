                ...
                <div class="dog-page">
                    <style>
                        ...
                        .dog-main .picpace-holder{  /*border: 5px solid #bbb; */
                            ...
                            border-radius: 10px;
                            height: 441px;
                            background: url('../../img/kennel-bg.png') no-repeat;
                    ...
                    <div class="dog-left">
                        ...
                        <ul>
                            ...
                            <li>
                                <label>General(<?php echo $breed['GameBreed']['gen'] . '/100'; ?>)</label>
                    ...
                    <div class="dog-main">
                        <div class="picpace-holder"> 
                            <?php if (!empty($breed['Breed']['BreedImages']['0']['filename_adult'])) { ?>
                                <img src="<?php echo SITE_URL; ?>timthumb.php?src=files/breeds/<?php echo $breed['Breed']['BreedImages']['0']['filename_adult']; ?>&w=400&h=300">
                            <?php } ?>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="dog-main">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <?php if (!empty($mydog)) { ?>
                                        <a href="<?php echo $this->webroot . 'kennels/do_breed/' . @$breed['GameBreed']['id'] . '/' . @$mydog['GameBreed']['id']; ?>">Breed</a>
                                    <?php } ?>
                                </div>
                                <div class="panel-body">
                                    <?php if (!empty($dogs)) { ?>
                                        <form id="selectDogForm" name="selectDogForm" method="post" action="<?php echo $this->webroot . 'kennels/select_stud/' . $breed['GameBreed']['id']; ?>">
                                                ...
                                                if (!empty($dogs)) {
                                                    foreach ($dogs as $dg) {
                                                        if ($dg['GameBreed']['id'] != $mydog['GameBreed']['id']) {
                                                            ?>
                                                            <option value="<?php echo $dg['GameBreed']['id']; ?>"><?php echo $dg['GameBreed']['name']; ?></option>
                                                            <?php
                                                        }
                                                    }
                                                }
                                            ...
                                            <p>OR</p>
                                            <a href="<?php echo $this->webroot . 'kennels/choose_stud/' . $breed['GameBreed']['id']; ?>">Search from Stud Listing</a>
                                        </form>
                                    <?php } ?>
                                </div>
                            </div>
                    ...
                    <div class="dog-main">
                        <div class="picpace-holder"> 
                            <?php if ($mydog["BreedImages"]["filename_adult"]) { ?>
                                <img src="<?php echo SITE_URL; ?>timthumb.php?src=files/breeds/<?php echo $mydog["BreedImages"]["filename_adult"]; ?>&w=400&h=300" ty="asd">
