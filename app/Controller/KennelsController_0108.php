...
//            if($currentdate % 2 == 0){
                ...
                $cday = date('d',$dat);
                if($cday != $currentdate){
                    $data = array('id' => $brd['GameBreed']['id'], 'age' => ($brd['GameBreed']['age'] + 1),'modified' => date('Y-m-d H:i:s',time()));
...
//            }
    ...
    function awards() {
        $allInventory = array(
          ...
          array('PACH-Preferred Agility Champion', '75 points plus two major wins'), 
          array('MACH-Master Agility Champion:', '60 points plus two major wins'), 
          array('AX-Agility Excellence:', '45 points plus 2 major wins'), 
          array('OA-Open Agility:', '30 points 2 major wins'), 
          array('NA- Novice Agility:', '15 points 2 major wins'), 
          array('OTCH-Obedience Trial Champion:', '70 points plus two major wins'), 
          array('UDX Utility Dog Excellent:', '55 plus two major wins'), 
          array('UD-Utility Dog:', '40 points plus 2 major wins'), 
          array('CDX-Companion Dog Excellent:', '25 points plus 2 major wins'), 
          array('CD-Companion Dog:', '15 points plus two major wins'), 
          array('RNC-Rally National Champion:', '100 points plus 2 major wins', '75 points plus 2 major wins'), 
          array('RAE-Rally advanced Excellent:', '60 points plus two major wins'), 
          array('RE-Ralley Excellence:', '45 points plus 2 major wins'), 
          array('RA-Rally Advanced:', '30 points plus 2 major wins'), 
          array('RN-Rally Novice:', '15 points plus 2 major wins'), 
          array('DC-Dual Champion:', 'Must have CH and GCH or OTCH or RNC or MACH'), 
          array('TC-Triple Champion:', 'MUST have CH,GCH and OTCH or RNC or MATCH'), 
          array('CGC-Canine Good Citizen:', 'Must complete CGC test'), 
          array('CGCA-Advance canine Good Citizen', 'CGCA test', 'A major win is one of these five', 'BOB-Best of Breed', 'BOW-Best of Winners', 'WD-winners Dog', 'WB-winners Bitch'));
