 ...
 */
 public function upload($file, $destination_dir, $user_thumb = false, $save_filename = '', $params = array(), $size_dimensions = array('width'=>50, 'height'=>50))
 {
	if ( !empty($file) )
	{		
 ...
 */
	public function crop( $filedata, $file_dimension, $is_thumb = array(), $params = array() )
	{
